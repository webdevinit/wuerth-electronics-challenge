...
class CapacitorModel(BaseModel): # Renamed from Capacitance
...
class InductorModel(BaseModel): # Renamed from Inductance
...
class ResistorModel(BaseModel): # Renamed from Resistor to avoid collision
